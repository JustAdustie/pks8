          ...
          children: [
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    ...
                    borderSide: const BorderSide(
                        color: Color.fromRGBO(73, 96, 156, 1), width: 1),
                  )),
            ),
            const SizedBox(
              height: 10,
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(
                    color: Color.fromRGBO(73, 96, 156, 1),
                    fontSize: 16.0,
                    fontWeight: FontWeight.w400,
                  ),
                  contentPadding: const EdgeInsets.symmetric(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(
                    color: Color.fromRGBO(73, 146, 156, 1),
                    fontSize: 16.0,
                    fontWeight: FontWeight.w400,
                  ),
                  contentPadding: const EdgeInsets.symmetric(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(15.0),
                    borderSide: const BorderSide(
                        color: const Color.fromRGBO(73, 96, 156, 1), width: 1),
                  )),
            ),
            const SizedBox(
              height: 40,
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                foregroundColor: const Color.fromRGBO(73, 96, 156, 1),
                ...
                shape: RoundedRectangleBorder(
                    ...
                    side: const BorderSide(
                        width: 2, color: Color.fromRGBO(73, 96, 156, 1))),
              ),
              onPressed: () async {
                //listLength += 1;
