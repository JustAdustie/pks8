                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return Dismissible(
                            ...
                            background: Container(
                              color: const Color.fromRGBO(73, 146, 156, 1),
                            ...
                            confirmDismiss: (direction) async {
                              final confirmed = await _showConfirmedDialog(
                                  context, flavor.name, flavor);

                              return confirmed ?? false;
                            },
                            onDismissed: (direction) {
                              Product pr = Product(
                                  id: _cartProductsUpd.elementAt(index).id,
                                  name: _cartProductsUpd.elementAt(index).name,
                                  description: _cartProductsUpd
                                      .elementAt(index)
                                      .description,
                                  price:
                                      _cartProductsUpd.elementAt(index).price,
                                  imageUrl: _cartProductsUpd
                                      .elementAt(index)
                                      .imageUrl,
                                  feature:
                                      _cartProductsUpd.elementAt(index).feature,
                                  isInCart: _cartProductsUpd
                                      .elementAt(index)
                                      .isInCart,
                                  quantity: _cartProductsUpd
                                      .elementAt(index)
                                      .quantity,
                                  isFavourite: _cartProductsUpd
                                      .elementAt(index)
                                      .isFavourite);
                              ApiService().changeProductStatus(pr);
                              setState(() {
                          ...
                          children: [
                            TextButton(
                              ...
                              style: TextButton.styleFrom(
                                backgroundColor: const Color.fromRGBO(73, 146, 156, 1),
